...
switch ($params[0]){
    ...
    case 'priceRossko':
        ...
        $fileNames = [
            ...
            '77769_F572FDAF9EE26AF5DEAA7C0C3341BB30.csv' => 25
        ];
        $ciphers = [
            4285574 => 'ROSP',
            258159 => 'ROJA',
    ...
    case 'BERG_MDMG': //Прайс ДМГ Москва
    case 'BERG_JARDMG': //Прайс ДМГ Ярославль
        ini_set('memory_limit', '2048M');
        ...
        if ($params[0] == 'BERG_MDMG') $store_id = 963806;
        if ($params[0] == 'BERG_JARDMG') $store_id = 963807;
