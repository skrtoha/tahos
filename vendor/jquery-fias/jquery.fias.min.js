!function (t, e) {
    ...
    t.fias.type = {
        ...
        i.push(u), u.done(function (t) {
            if (t.result.length != 1) t.result = t.result.slice(1);
        ...
        return i(a, function () {
            ...
            function b() {
                function e() {
                    var e = r.val();
                    if (e) {
                        var n, a = j(e), i = a.type, o = a.parentType, l = t.fias.type, u = !0,
    ...
    t.fn.fiasZip = function (e, n) {
        return this.keydown(function (e) {
            ...
            var a = t(this), i = a.val();
            return i ? void t.fias.api({type: t.fias.type.building, zip: i, withParents: !0, limit: 1}, function (a) {
                var i = a.length && a[0];
